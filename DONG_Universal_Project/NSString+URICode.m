...
#import "NSString+URICode.h"

@implementation NSString (URICode)
...
+ (NSString*) escapeURIComponent:(NSString*)src {
    ...
    __autoreleasing NSString *encodedString = (NSString *)CFBridgingRelease(CFURLCreateStringByAddingPercentEscapes(NULL,
                                                                                                                    (CFStringRef)src,
                                                                                                                    NULL,
